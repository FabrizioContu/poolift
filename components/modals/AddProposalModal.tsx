      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
              ...
              <div key={index} className="border border-border rounded-lg p-3">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-ring focus:border-transparent "
                  />
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="Precio"
                      className="w-24 px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-ring focus:border-transparent "
                    />
                    <input
                      type="url"
                      ...
                      className="flex-1 px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-ring focus:border-transparent "
                    />
                  </div>
                </div>
              </div>
          ...
          <button
            type="button"
            onClick={addItem}
            className="mt-2 flex items-center gap-1 text-primary hover:text-primary/70 text-sm"
          >
            <Plus size={16} />
            Agregar item
          </button>

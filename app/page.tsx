        ...
        <section id="como-funciona" className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              {/* Fork: two options */}
              <div className="mt-12 p-6 bg-white rounded-xl border-2 border-bondi-blue-100">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <Link href="/create-direct-gift" className="block">
                    <div className="p-4 border border-gray-200 rounded-lg hover:border-emerald-400 hover:bg-emerald-50 transition group">
                  ...
                  <Link href="/create-group" className="block">
                    <div className="p-4 border border-gray-200 rounded-lg hover:border-bondi-blue-300 hover:bg-bondi-blue-50 transition group">
                      <div className="flex items-center gap-2 mb-2">
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-gray-700">
              Ya tienes un codigo?{" "}
              <Link href="/join" className="text-bondi-blue-500 hover:underline">
                Unirse a grupo
              </Link>
            </p>
          </div>
